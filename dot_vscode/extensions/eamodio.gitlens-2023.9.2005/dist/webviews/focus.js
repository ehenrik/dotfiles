...
`;var St=Object.defineProperty,Et=Object.getOwnPropertyDescriptor,Pt=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?Et(t,o):t,s=e.length-1;s>=0;s--)(i=e[s])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&St(t,o,r),r};let Tt=class extends nt{constructor(){super(...arguments),this.full=!1,this.tabIndex=0}get role(){return this.href?"link":"button"}render(){const e=De`<slot></slot>`;return null!=this.href?De`<a href=${this.href}>${e}</a>`:e}};Tt.styles=[Ct,oe`
			:host {
		...
		`],Pt([ct({type:Boolean,reflect:!0})],Tt.prototype,"full",2),Pt([ct()],Tt.prototype,"href",2),Pt([ct({reflect:!0})],Tt.prototype,"role",1),Pt([ct()],Tt.prototype,"appearance",2),Pt([ct({type:Number,reflect:!0})],Tt.prototype,"tabIndex",2),Tt=Pt([rt("gl-button")],Tt);var Ot=Object.defineProperty,Rt=Object.getOwnPropertyDescriptor,Mt=(e,t,o,n)=>{for(var i,r=n>1?void 0:n?Rt(t,o):t,s=e.length-1;s>=0;s--)(i=e[s])&&(r=(n?i(t,o,r):i(r))||r);return n&&r&&Ot(t,o,r),r};let Nt=class extends nt{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};Nt.styles=oe`
		:host {
